...
The next G2a run is configured to collect every current exact refrigerator SKU. Any `NOT_ATTEMPTED` SKU now fails the run; hosted execution is capped at 45 minutes.
