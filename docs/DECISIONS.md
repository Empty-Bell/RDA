...
CURRENT_TASK.md and their dedicated review documents.
...
Monitor reconnaissance: qbg3-d468 Product Type separates monitor/signage applicability
(D09); Smart Monitor TV apps are not a TV classification rule. Monitor total energy
at 115 V (kWh/yr), mode power W, certification energy limit and USB-C delivered W
