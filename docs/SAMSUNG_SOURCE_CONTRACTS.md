# Samsung source contracts — refrigerator recon v0.1

Observed on GitHub-hosted Ubuntu 24.04 x64, 2026-09-16. Refrigerator only;
other 10 product groups remain UNKNOWN. No compliance semantics implemented.
