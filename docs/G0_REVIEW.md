...
| Sanitized fixture path/byte integrity | New dedicated g0-review.yml checks actual Ubuntu checkout bytes and uploads a report | This is repository integrity, not raw artifact availability, parser coverage or G0 promotion |
